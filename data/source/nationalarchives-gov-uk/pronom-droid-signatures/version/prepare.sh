...
tidy.sh -w -od automatic source/droid-signature-files.htm
justify.sh source/droid-signature-files.htm automatic/droid-signature-files.htm.tidy tidy

echo automatic/droid-signature-files.htm.tidy.csv
saxon.sh ../../src/html2csv.xsl html csv -w -od automatic automatic/droid-signature-files.htm.tidy 
